...
Fare: To be confirmed before dispatch`    :`Pickup: Shehnaaz's Mehndi
...
if (!hydrated) {
return ( <div className="container-page py-20 text-center text-brown-400">
Loading your cart… </div>
);
}

if (items.length === 0) return null;

return ( <div className="container-page py-10 sm:py-14"> <h1 className="font-display text-3xl sm:text-4xl text-mehndi-800">
Checkout </h1>
