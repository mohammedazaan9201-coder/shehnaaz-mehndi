...
export const seedProducts: Product[] = [
  ...
  },
  {
    ...
    price: 80,
    images: ["/products/real-p-aftercare-oil.jpg"],
    categorySlug: "mehndi-cones",
    stock: 50,
    isActive: true,
  },
  ...
  // Instant Products
  {
    ...
    price: 100,
    images: ["/products/instant-products.svg"],
  ...
  // Stencils
  {
    ...
    price: 100,
    images: ["/products/real-p-stencil-medium.jpg"],
  ...
  },
  {
    ...
    price: 180,
    images: ["/products/real-p-stencil-medium-2.jpg"],
    categorySlug: "stencils",
  ...
  },
  {
    ...
    price: 120,
    images: ["/products/real-p-stencil-large.jpg"],
    categorySlug: "stencils",
    variantLabel: "Large",
    stock: 45,
    isActive: true,
  },
  {
    ...
    price: 200,
    images: ["/products/real-p-stencil-large-2.jpg"],
    categorySlug: "stencils",
  ...
  },
  {
    ...
    price: 60,
    images: ["/products/real-p-stencil-fingers.jpg"],
    categorySlug: "stencils",
  ...
  },
  {
    ...
    price: 100,
    images: ["/products/real-p-stencil-fingers-2.jpg"],
    categorySlug: "stencils",
  ...
  },
  {
    ...
    price: 40,
    images: ["/products/real-p-stencil-kids.jpg"],
    categorySlug: "stencils",
    variantLabel: "Kids",
    stock: 60,
    isActive: true,
  },
  {
    ...
    price: 100,
    images: ["/products/real-p-stencil-kids-3.jpg"],
    categorySlug: "stencils",
  ...
  },
  {
    ...
    price: 400,
    images: ["/products/real-p-stencil-bridal-full.jpg"],
    categorySlug: "stencils",
  ...
  },
  {
    ...
    price: 250,
    images: ["/products/real-p-stencil-semi-bridal.jpg"],
    categorySlug: "stencils",
  ...
  // Powders & Hair Care
  {
    ...
    price: 120,
    images: ["/products/real-p-ubtan.jpg"],
  ...
  },
  {
    ...
    price: 120,
    images: ["/products/real-p-wax-powder.jpg"],
    categorySlug: "powders-hair-care",
    stock: 40,
    isActive: true,
  },
  {
    ...
    price: 200,
    images: ["/products/real-p-hair-powder-black.jpg"],
    categorySlug: "powders-hair-care",
    variantLabel: "Black",
    stock: 30,
    isActive: true,
  },
  {
    ...
    price: 200,
    images: ["/products/real-p-hair-powder-brown.jpg"],
    categorySlug: "powders-hair-care",
    variantLabel: "Brown",
    stock: 30,
    isActive: true,
  },
  {
    ...
    price: 200,
    images: ["/products/real-p-hair-powder-burgundy.jpg"],
    categorySlug: "powders-hair-care",
  ...
  },
  {
    ...
    price: 150,
    images: ["/products/powders-hair-care.svg"],
    categorySlug: "powders-hair-care",
    stock: 35,
    isActive: true,
  },
  ...
  },
  {
    ...
    price: 200,
    images: ["/products/real-p-soap-anti-acne.jpg"],
    categorySlug: "skincare",
    stock: 35,
    isActive: true,
  },
  ...
  },
  {
    ...
    price: 200,
    images: ["/products/real-p-soap-skin-lightening.jpg"],
    categorySlug: "skincare",
    stock: 30,
    isActive: true,
  },
  ...
  },
  {
    ...
    price: 200,
    images: ["/products/real-p-soap-menthol.jpg"],
    categorySlug: "skincare",
    stock: 30,
    isActive: true,
  },
